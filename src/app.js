...
window.addEventListener("load", () => {
    ...
    const sectionOne = document.querySelector('.section-container-1');
    const sectionTwo = document.querySelector('.section-container-2');
    const sectionThree = document.querySelector('.section-container-3');
    const sectionFour = document.querySelector('.section-container-4');
    //   window.addEventListener('scroll', () => {
    window.addEventListener('wheel', () => {
        ...
        logoContainer.style.transform = `scale(${scale})`;
        const activeSection = [sectionOne, sectionTwo, sectionThree, sectionFour].find((section) => {
            const sectionTop = section.getBoundingClientRect().top;
            return sectionTop >= 0;
        });
        if (activeSection) {
